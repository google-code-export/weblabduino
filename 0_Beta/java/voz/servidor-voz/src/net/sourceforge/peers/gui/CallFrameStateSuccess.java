...
public class CallFrameStateSuccess extends CallFrameState {
    ...
    public CallFrameStateSuccess(String id, CallFrame callFrame, Logger logger) {
        ...
        callPanel.add(new JLabel("Recebendo comandos de voz..."));
        JButton hangupButton = new JButton("Parar");
    ...
    public void remoteHangup() {
        ...
        CallFrameStateRemoteHangup fecharFrameHangup = new CallFrameStateRemoteHangup(id, callFrame, logger);
        fecharFrameHangup.closeClicked();
    }
