...
public class CallFrame implements ActionListener, WindowListener {
    ...
    public static final String HANGUP_ACTION_COMMAND    = "desligar";
    public static final String PICKUP_ACTION_COMMAND    = "atender";
    public static final String BUSY_HERE_ACTION_COMMAND = "ocupado";
    public static final String CLOSE_ACTION_COMMAND     = "fechar";
