...
public class JavaDummyApplet extends WebLabApplet {
	...
	public static final String DEFAULT_WEBCAM_IMAGE_URL       = "img/webcam/pullupdown.jpg";
	...
	public JavaDummyApplet(){
		...
		JButton buttonIniciar = new JButton("Ligar lâmpada");
		buttonsPanel.add(buttonIniciar);	
		 */
		
		final JPanel textPanel = new JPanel();
		textPanel.setLayout(new FlowLayout(FlowLayout.CENTER));
		textPanel.add(new JLabel("Este é o experimento Pull-Up Pull-Down, \n"));
		textPanel.add(new JLabel("para visualizá-la reserve o experimento no botão abaixo."));
		this.getContentPane().add(textPanel);
	
		/*
		final Command commandIniciar = new  PulseCommand(1, true);
		...
		buttonIniciar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JavaDummyApplet.this.getBoardController().sendCommand(commandIniciar, new ICommandCallback() {
